...
//        CGSize expectedSizeTitle = [title sizeWithFont:titleLabel.font constrainedToSize:maxSizeTitle lineBreakMode:titleLabel.lineBreakMode];
        CGRect  expectedRectTitle = [title boundingRectWithSize:maxSizeTitle options:titleLabel.lineBreakMode attributes:@{NSFontAttributeName:titleLabel.font} context:nil];
        CGSize expectedSizeTitle = expectedRectTitle.size;
...
//        CGSize expectedSizeMessage = [message sizeWithFont:messageLabel.font constrainedToSize:maxSizeMessage lineBreakMode:messageLabel.lineBreakMode];
        CGSize expectedSizeMessage = [message boundingRectWithSize:maxSizeMessage options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:messageLabel.font} context:nil].size;
