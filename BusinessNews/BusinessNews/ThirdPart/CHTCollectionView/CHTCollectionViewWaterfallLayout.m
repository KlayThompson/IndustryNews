...
- (CGSize)collectionViewContentSize {
  ...
  contentSize.height = [[[self.columnHeights lastObject] firstObject] floatValue];
    ...
    //164为状态栏+导航栏+底部tab栏+搜索框
  if (contentSize.height<[UIScreen mainScreen].bounds.size.height - 164-45) {
        contentSize.height =[UIScreen mainScreen].bounds.size.height - 164-45;
  }
